...
const Head = () => {
  ...
  return (
    <div className='sticky top-0 left-0 right-0 z-30 flex items-center justify-between gap-4 p-4 overflow-hidden text-white shadow sm:py-4 md:px-6 grad-to-right'>
